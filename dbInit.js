...
sequelize.sync({ force }).then(async () => {
	const init = [
		...
		TransferMarket.upsert({ name: 'E. Haaland', value: 95, club: 'Dortmund', position: 'ST', current_rating: 80, age: 18, wage: 10000 }),
		...
		YouthCoaches.upsert({ name: 'Humbolt', level: 5, wage: 100000 }),
		YouthCoaches.upsert({ name: 'Ashcroft', level: 4, wage: 70000 }),
		YouthCoaches.upsert({ name: 'Oladije', level: 2, wage: 30000 }),
		YouthCoaches.upsert({ name: 'Inamina', level: 4, wage: 70000 }),
		YouthCoaches.upsert({ name: 'Khan', level: 1, wage: 10000 }),
		YouthCoaches.upsert({ name: 'Monjur', level: 5, wage: 100000 }),
		YouthCoaches.upsert({ name: 'Pasarella', level: 4, wage: 70000 }),
		YouthCoaches.upsert({ name: 'Xi', level: 3, wage: 50000 })
	];
